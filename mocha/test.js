...
describe('Battleship API', () => {
  ...
  describe('create-game', () => {
    it('should return status 200', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], lens: [1], values: [1], verts: [false]})
      .end((err, res) => {
        res.should.have.status(200);
        done();
      });
    ...
    it('should return error if missing ships (2D array of ship coordinates) input', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({lens: [1], values: [1], verts: [false]})
      .end((err, res) => {
    ...
    it('should return error if missing lens (array of ship lengths) input', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], values: [1], verts: [false]})
      .end((err, res) => {
        expect(res.error.text).to.equal('missing inputs');
        res.should.have.status(400);
        done();
    ...
    it('should return error if missing values (ship labels) input', (done) => {
      chai.request(app)
      .post('/create-game')
    ...
    it('should return error if missing verts (array of ship orientations) input', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], lens: [1], values: [1]})
      .end((err, res) => {
        expect(res.error.text).to.equal('missing inputs');
        res.should.have.status(400);
        done();
    ...
    it('should return error if ships is not a 2D array', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [0, 1], lens: [1], values: [1], verts: [false]})
      .end((err, res) => {
    ...
    it('should return error if values is not an array', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], lens: [1], values: 1, verts: [1]})
      .end((err, res) => {
        expect(res.error.text).to.equal('values input not an array');
        res.should.have.status(400);
        done();
      });
    });
    ...
    it('should return error if ships, lens, and verts are not the same length', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], lens: [1, 2, 3, 4], values: [1], verts: [true]})
      .end((err, res) => {
    ...
    it('should return error if ships contains invalid coordinates (not on 10x10 board)', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 100]], lens: [1], values: [1], verts: [true]})
      .end((err, res) => {
    ...
    it('should return error if lens contains invalid ship lengths (< 1 or > 10)', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 10]], lens: [11], values: [1], verts: [true]})
      .end((err, res) => {
    ...
    it('should return error if verts contains invalid ship orientation (not a boolean)', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], lens: [10], values: [1], verts: [2]})
      .end((err, res) => {
    ...
    it('should return error if a portion of the vertically oriented ship is off the board', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[5, 0]], lens: [10], values: [1], verts: [true]})
      .end((err, res) => {
    ...
    it('should return error if a portion of the horizontally oriented ship is off the board', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 5]], lens: [10], values: [1], verts: [false]})
      .end((err, res) => {
    ...
    it('should return error if there is already a ship in one of the cells', (done) => {
      ...
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], lens: [1], values: [1], verts: [false], board: array})
      .end((err, res) => {
    ...
    it('should create a new 100 element array gameboard of 0s without board input and place ship at (0,0)', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0]], lens: [1], values: [1], verts: [true]})
      .end((err, res) => {
    ...
    it('should place 3 vertically oriented submarines (length: 3) at [[0,0],[0,1],[0,2]]', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[0, 0], [0, 1], [0, 2]], lens: [3, 3, 3], values: [1, 1, 1], verts: [true, true, true]})
      .end((err, res) => {
        let array = Array(100).fill(0);
        let positions = [0, 1, 2, 10, 11, 12, 20, 21, 22];
        array = array.map((e, i) => (positions.indexOf(i) !== -1) ? 1 : 0);
        expect(JSON.stringify(res.body.board)).to.equal(JSON.stringify(array));
        res.should.have.status(200);
        done();
      });
    ...
    it('should place 3 horizontally oriented battleships (length: 5) at [[4,4],[5,4],[6,4]]', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[4, 4], [5, 4], [6, 4]], lens: [5, 5, 5], values: [1, 1, 1], verts: [false, false, false]})
      .end((err, res) => {
        let array = Array(100).fill(0);
  ...
  describe('make-move', () => {
    ...
    it('should return hit if ship was hit', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[4, 4], [5, 4], [6, 4]], lens: [5, 5, 5], values: [1, 2, 3], verts: [false, false, false]})
      .end((err, res) => {
        chai.request(app)
        .post('/make-move')
        .send({shot: [5, 4]})
    ...
    it('should return sunk if all the cells of a single ship are hit', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[4, 4], [5, 4], [6, 4]], lens: [3, 2, 4], values: [1, 2, 3], verts: [false, false, false]})
      .end((err, res) => {
        chai.request(app)
        .post('/make-move')
        .send({shot: [5, 4]})
    ...
    it('should return won if all ships are sunk', (done) => {
      chai.request(app)
      .post('/create-game')
      .send({ships: [[4, 4], [5, 4], [6, 4]], lens: [1, 1, 1], values: [1, 2, 3], verts: [false, false, false]})
      .end((err, res) => {
        chai.request(app)
        .post('/make-move')
        .send({shot: [4, 4]})
